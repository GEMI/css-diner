var levels = [
    {
        ...
        helpTitle: "Select elements by HTML tag type",
        selector: "plate",
        syntax: "DIV",
        help: "Selects all elements of type <strong>DIV</strong>. Type refers to the type of tag, so <tag>div</tag>, <tag>p</tag> and <tag>ul</tag> are all different HTML element types.",
        examples: [
            '<strong>div</strong> selects all <tag>div</tag> elements.',
            '<strong>p</strong> selects all <tag>p</tag> elements.',
            '<strong>span</strong> selects all <tag>span</tag> elements.',
            '<strong>a</strong> selects all <tag>a</tag> elements.',
            '<strong>plate</strong> selects all <tag>plate</tag> elements.'
        ],
    ...
    {
        doThis: "Select the plate on a bento",
        selectorName: "Type Selector",
        helpTitle: "Select elements by their type",
        selector: "plate",
        syntax: "DIV",
    ...
    },
    {
        ...
        helpTitle: "Select elements by their ID value",
        selector: "#fancy",
        syntax: "#ID",
        help: 'Selects the element with a specific <strong>ID</strong> value. You can also combine the ID selector with the type selector that you have learned in previous lesson.',
        examples: [
            '<strong>#cool</strong> selects any element with <strong>id="cool"</strong>',
            '<strong>div#long</strong> selects <tag>div id="long"</tag>',
            '<strong>ul#cool</strong> selects <tag>ul id="cool"</tag>',
            '<strong>p#primary</strong> selects <tag>p id="primary"</tag>'
        ],
    ...
    },
    {
        ...
        boardMarkup: '<plate/><apple id="central"/><bento/>'
    },
    {
    ...
    },
    {
        helpTitle: "Select an element inside another element",
        selectorName: "Descendant Selector",
        doThis: "Select the orange on the bento",
        ...
        examples: [
            '<strong>p&nbsp;&nbsp;strong</strong> selects all <tag>strong</tag> elements that are inside of any <tag>p</tag>',
            '<strong>#fancy&nbsp;&nbsp;span</strong> selects any <tag>span</tag> elements that are inside of the element with <strong>id="fancy"</strong>',
            '<strong>div&nbsp;&nbsp;span</strong> selects any <tag>span</tag> elements that are inside of the <strong>div</strong> elements'
        ],
        boardMarkup: '<bento/><apple/><bento><orange/></bento>'
    },
    {
        ...
        syntax: "#ID&nbsp;&nbsp;A",
        help: 'You can combine multiple selector types to find elements in CSS',
        examples: [
            '<strong>#cool&nbsp;span</strong> selects all <tag>span</tag> elements that are inside of elements with <strong>id="cool"</strong>',
            '<strong>#primary&nbsp;div</strong> selects all <tag>div</tag> elements that are inside of elements with <strong>id="primary"</strong>'
        ],
    ...
    },
    {
        ...
        helpTitle: "Select elements by their class name",
        syntax: ".classname",
        help: 'The class selector selects all elements with that class attribute. Elements can only have one ID, but multiple classes. Thus class selector is preferred over ID selector!',
        examples: [
            '<strong>.small</strong> selects all elements with <strong>class="small"</strong>',
            '<strong>.small .closed</strong> selects all elements with <strong>class="closed"</strong> inside of elements <strong>class="small"</strong>'
        ],
    ...
    },
    {
        ...
        boardMarkup: '<apple/> <apple class="small"/> <bento> <orange class="small"/> </bento> <plate> <orange/> </plate> <plate> <orange class="small"/> </plate>'
    },
    {
        doThis: "Select the small oranges in the bentos",
        selector: "bento orange.small",
        syntax: "Combine selectors from previous lessons",
        helpTitle: "Test your skills!",
    ...
    },
    {
        ...
        selectorName: "Combined selector",
        helpTitle: "Combine, selectors, with... commas! Write multiple selectors using comma separator.",
        syntax: "A, B",
    ...
    },
    {
        ...
        examples: [
            '<strong>p *</strong> selects all elements inside <tag>p</tag> elements.'
        ],
    ...
    },
    {
        ...
        boardMarkup: '<bento> <apple class="small"/> </bento> <plate /> <apple class="small"/> <plate /> <apple/> <apple class="small"/> <apple class="small"/>'
    },
    {
        ...
        boardMarkup: '<pickle/> <bento> <orange class="small"/> </bento> <pickle class="small"/> <pickle/> <plate> <pickle/> </plate> <plate> <pickle class="small"/> </plate>'
    },
    {
    ...
    },
    {
        ...
        boardMarkup: '<bento/> <plate /> <plate> <orange /> <orange /> <orange /> </plate> <pickle class="small" />'
    },
    {
        ...
        boardMarkup: '<plate> <apple/> </plate> <plate> <pickle /> </plate> <bento> <pickle /> </bento> <plate> <orange class="small"/> <orange/> </plate> <pickle class="small"/>'
    },
    {
    ...
    },
    {
        ...
        boardMarkup: '<plate/> <bento/> <plate> <orange/> <orange/> <orange/> </plate> <bento/>'
    },
    {
        ...
        boardMarkup: '<orange class="small"/> <apple/> <apple class="small"/> <apple/> <apple class="small"/> <plate> <orange class="small"/> <orange/> </plate>'
    },
    {
    ...
    },
    {
        ...
        boardMarkup: '<plate/> <plate> <pickle class="small" /> </plate> <plate> <apple class="small" /> </plate> <plate/> <plate> <apple /> </plate> <plate/>'
    },
    {
        ...
        boardMarkup: '<plate id="fancy"> <apple class="small" /> <apple /> </plate> <plate> <apple class="small" /> </plate> <plate> <pickle /> </plate>'
    },
    {
    ...
    },
    {
        ...
        boardMarkup: '<plate id="fancy"> <apple class="small" /> </plate> <plate> <apple /> </plate> <apple /> <plate> <orange class="small" /> </plate> <pickle class="small" />'
    },
    {
        ...
        boardMarkup: '<bento><apple class="small"/></bento> <apple for="Elon"/> <plate for="Eva"><pickle/></plate> <bento for="Jenna"><orange/></bento> <pickle/>'
    },
    {
        selectorName: "Attribute Selector",
        helpTitle: "Select all elements that have a specific attribute",
    ...
    },
    {
        ...
        boardMarkup: '<apple for="Ivan" /> <bento for="Albina"><apple /></bento> <bento for="Jeff"><orange/></bento> <pickle/>'
    },
    {
    ...
    },
    {
        ...
        boardMarkup: '<apple class="small"/> <bento for="Jim"><pickle/></bento> <apple for="Ryota"></apple> <plate for="Minato"><orange/></plate> <pickle class="small"/>'
    },
    {
        ...
        boardMarkup: '<bento for="Robbie"><apple /></bento> <bento for="Timmy"><pickle /></bento> <bento for="Tom"><orange /></bento>'
    }
];